...
import {dat1,dat2} from "../data/activewear"
const Activewear = () => {
...
const navigate=useNavigate()
  ...
  return (
    <div>
        <Heading style={{textAlign:'start',margin:"20px"}} size="md">Mens activewear</Heading>


        <div style={{display:"flex",width:"100%",gap:"10px",margin:"auto",marginTop:"20px",textAlign:"start",marginBottom:'-400px'}}>
             <div ><Link to="/shirt"><img style={{height:"43%",marginLeft:100}} src="https://n.nordstrommedia.com/id/sr3/6ddfacbb-cf1b-4b34-99ff-75b78c861e4f.jpeg?crop=pad&pad_color=FFF&format=jpeg&w=780&h=1196"/>
...
<Heading  style={{textAlign:'start',margin:"20px"}}>Womens Activewear</Heading>
